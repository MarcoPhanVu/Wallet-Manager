...
<?php
	...
	if (isset($_POST["transactionCreated"])) {
		...
		// Submit data
		if (empty($transWallet_ErrMsg) && empty($transCategory_ErrMsg) && empty($transAmount_ErrMsg) && empty($transDetails_ErrMsg) && empty($transDate_ErrMsg)) {
			// Submitted + No Error Message => proceed

			$sql_statement = "INSERT INTO transactions (walletID, categoryID, amount, description, date) VALUES ('$transWallet_Data', '$transCategory_Data', '$transAmount_Data', '$transDetails_Data', '$transDate_Data')";

			echo "here: " . $sql_statement . "<br>";
...
<section class="alter_info">
	...
	<div class="info-display-tab">
		<?php 
			// echo "<p>WalletId: " . $_POST["transWallet"] . "</p>"; 
			// echo "<p>CategoryId: " . $_POST["transCategory"] . "</p>"; 
			// echo "<p>Transaction Amount: " . $_POST["transAmount"] . "</p>"; 
			// echo "<p>Transaction Details: " . $_POST["transDetails"] . "</p>"; 
			// echo "<p>Transaction Date: " . $_POST["transDate"] . "</p>"; 
			// echo "<p>Transaction created " . $_POST["transactionCreated"] . "</p>"; 

			echo "<p>WalletId: " . $transWallet_Data . "</p>"; 
			echo "<p>CategoryId: " . $transCategory_Data . "</p>"; 
			echo "<p>Transaction Amount: " . $transAmount_Data . "</p>"; 
			echo "<p>Transaction Details: " . $transDetails_Data . "</p>"; 
			echo "<p>Transaction Date: " . $transDate_Data . "</p>"; 
			echo "<p>Transaction created " . isset($_POST["transactionCreated"]) . "</p>"; 
		?>
	</div>
