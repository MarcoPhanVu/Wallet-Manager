...
<!-- CATEGORIESSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS -->
<section class="alter_info" id="info_category">
...
<!-- TRANSACTIONSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS -->
<section class="alter_info hidden" id="info_transaction">
